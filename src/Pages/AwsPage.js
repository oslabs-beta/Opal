  ...
  return (
    <div className="h-screen w-full flex">
      ...
      >
        ...
        {sidebarActive ? (
          <>
            <p className="text-white text-2xl whitespace-nowrap mb-1">
              Aws Lambda
            </p>
            <p className="text-white text-2xl whitespace-nowrap"> Dashboard</p>
          </>
        ) : (
          <>
            <p className="text-[#363740] whitespace-nowrap text-2xl">A</p>
            <p className="whitespace-nowrap text-2xl text-[#363740]">hi</p>
          </>
        )}
        <br />
